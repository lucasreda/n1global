...
interface BackdropFilterControlsProps {
  value?: string;
  onChange: (value: string) => void;
  onReset?: () => void;
}

interface BackdropFilterValues {
  blur: number;
  brightness: number;
  contrast: number;
  grayscale: number;
...
const defaultFilters: BackdropFilterValues = {
  blur: 0,
  brightness: 100,
  contrast: 100,
  grayscale: 0,
...
const glassmorphismPreset: BackdropFilterValues = {
  blur: 10,
  brightness: 100,
  contrast: 100,
  grayscale: 0,
...
// Parse backdrop-filter string
function parseBackdropFilter(filterString?: string): BackdropFilterValues {
...
function buildBackdropFilter(values: BackdropFilterValues): string {
  const parts: string[] = [];
...
export function BackdropFilterControls({ value, onChange, onReset }: BackdropFilterControlsProps) {
  const filters = parseBackdropFilter(value);
  
  const handleFilterChange = (filterName: keyof BackdropFilterValues, newValue: number) => {
    const updated = { ...filters, [filterName]: newValue };
    onChange(buildBackdropFilter(updated));
  };
  ...
  const applyGlassmorphism = () => {
    onChange(buildBackdropFilter(glassmorphismPreset));
  };
  
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-2">
        <Label className="text-xs text-muted-foreground">Backdrop Filter</Label>
        <div className="flex gap-1">
          <Button
            variant="outline"
            size="sm"
            onClick={applyGlassmorphism}
            className="h-7 px-2 text-xs"
            data-testid="button-glassmorphism-preset"
          >
          ...
          <Button
            ...
            onClick={handleReset}
            className="h-7 px-2 text-xs"
            data-testid="button-reset-backdrop-filter"
          >
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={0.5}
          className="w-full"
          data-testid="slider-backdrop-blur"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-brightness"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-contrast"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-saturate"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-grayscale"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-hue-rotate"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-invert"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          step={1}
          className="w-full"
          data-testid="slider-backdrop-sepia"
        />
      </div>
    </div>
  );
