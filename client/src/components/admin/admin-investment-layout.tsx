...
interface AdminInvestmentLayoutProps {
...
const sidebarItems = [
  ...
  },
  {
    icon: PiggyBank,
    label: "Pools",
    href: "/admin-investment/pools"
  },
  {
    icon: Users,
    label: "Investidores",
    href: "/admin-investment/investors"
  },
  {
    icon: BarChart3,
    label: "Analytics",
    href: "/admin-investment/analytics"
  },
  {
    icon: CreditCard,
    label: "Transações",
  ...
  },
  {
    icon: Bell,
    label: "Notificações",
    href: "/admin-investment/notifications"
  },
  {
    icon: Settings,
    label: "Configurações",
    href: "/admin-investment/settings"
  }
];

export function AdminInvestmentLayout({ children }: AdminInvestmentLayoutProps) {
