    ...
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <div className="relative z-50">
        ...
        <section className="min-h-screen sm:py-20 lg:py-32 flex items-center relative overflow-hidden bg-black">
          ...
          <div className="absolute top-[150px] left-0 right-0 bottom-0 sm:inset-0 bg-gradient-to-b from-black/95 to-transparent sm:bg-gradient-to-r sm:from-black/80 sm:to-transparent"></div>
