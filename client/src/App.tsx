...
import AffiliatesRequests from "@/pages/admin/affiliates-requests";
...
import ProductPixels from "@/pages/affiliate/product-pixels";
  ...
  return (
    <OnboardingGuard>
      <Switch>
        ...
        <Route path="/inside/affiliates/landing-pages/:id/edit" component={isSuperAdmin ? ({ params }: any) => (
          <AffiliateLandingPageVisualEditor landingPageId={params.id} />
        ) : () => <NotFound />} />
        ...
        <Route path="/inside/affiliates/requests" component={isSuperAdmin ? () => <AdminLayout><AffiliatesRequests /></AdminLayout> : () => <NotFound />} />
        ...
        {/* Affiliate Routes */}
        <Route path="/affiliate/products/:productId/pixels" component={isAffiliate ? ProductPixels : () => <NotFound />} />
